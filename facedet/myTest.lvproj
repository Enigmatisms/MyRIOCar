...
<Project Type="Project" LVVersion="15008000">
	...
	<Property Name="varPersistentID:{12F16BC3-7F0B-4232-94E6-6F383A57AF63}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/follow right</Property>
	<Property Name="varPersistentID:{31027D66-E1FC-41FD-A3BF-22435633F85B}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/foward</Property>
	<Property Name="varPersistentID:{3813C039-1978-40FC-9E12-6C2C0C0E6D52}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/distance</Property>
	<Property Name="varPersistentID:{3B5FC407-1278-45A5-8BA7-B8F4AF1632CA}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/manual</Property>
	<Property Name="varPersistentID:{420428E9-ECA6-4D5A-AFAC-B9A8CE32AF64}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/face</Property>
	<Property Name="varPersistentID:{56A7AF51-FF7A-4B71-B060-360B8247CC02}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/analog</Property>
	<Property Name="varPersistentID:{587C12E2-A76B-4CA8-BA36-A8368E13BB24}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/threshold</Property>
	<Property Name="varPersistentID:{64D2D163-444F-4D24-AF80-4F3C6D386ED6}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/halfsetter</Property>
	<Property Name="varPersistentID:{67341F19-6DA5-43E2-8B80-807C20740F58}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/spin time</Property>
	<Property Name="varPersistentID:{7C4F7221-C4D8-402C-8B00-58E6B2DF8830}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/follow left</Property>
	<Property Name="varPersistentID:{8C1677B5-87F8-4019-AE5F-FAB07B6E55FF}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/control trace</Property>
	<Property Name="varPersistentID:{979162D7-71CE-44C0-95F7-66F23BBE6807}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/PID Given</Property>
	<Property Name="varPersistentID:{A7037405-47AD-43CA-93FB-8CE8B57F8396}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/speed</Property>
	<Property Name="varPersistentID:{B4E46361-44FD-4021-8924-DB4C9BEA3495}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/Right forward</Property>
	<Property Name="varPersistentID:{BE3572B5-91CD-4844-925B-D67D8FC38C1D}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/angular v</Property>
	<Property Name="varPersistentID:{BF609158-18E4-4FC4-9729-30D81842D75C}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/Left forward</Property>
	<Property Name="varPersistentID:{CE296510-EC18-4C97-BDA0-499EB089C5FE}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/Control</Property>
	<Property Name="varPersistentID:{D5C49059-48D8-4986-8983-C1B7EAA0F26F}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/angle</Property>
	<Property Name="varPersistentID:{EF9AEEFF-5874-45FF-9547-8163EA14D017}" Type="Ref">/NI-myRIO-1900-03050c9a/myTest.lvlib/Control on</Property>
	...
	<Item Name="NI-myRIO-1900-03050c9a" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-03050c9a</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="myTest.lvlib" Type="Library" URL="../myTest.lvlib"/>
		<Item Name="WebService1" Type="Web Service">
			<Property Name="ws.guid" Type="Str">{D112856E-37A3-4DB0-A100-7AA590BEDD9D}</Property>
